...
function App() {
  ...
  useEffect(() => {
    const storyIds = ['die-ritterburg', 'der-mond', 'skifahren-in-andermatt', 'der-zauber-zoo', 'das-rockfestival', 'das-tal-der-sanften-riesen', 'goldi-im-labyrinth', 'am-ende-der-welt', 'die-stadt-der-vergessenen-spielzeuge', 'der-wolkenfluester', 'der-schachmeister', 'der-flughafen', 'das-kloster-in-den-wolken', 'bobo-der-siebenschlafer', 'der-kindergarten', 'der-osterhase', 'das-museum-der-lebendigen-statuen', 'das-urzeittal', 'die-dracheninsel']
    Promise.all(
      storyIds.map((id) =>
