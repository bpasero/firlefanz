...
if (!storyId) {
  console.error('Usage: node scripts/generate-pdf.mjs <story-id>');
  console.error('Example: node scripts/generate-pdf.mjs goldi-im-labyrinth');
  process.exit(1);
}
...
for (let i = 0; i < story.pages.length; i++) {
  ...
  // Right half: text on paper-colored background
